...
module.exports = class WechatWorkStrategy extends passport.Strategy {
  constructor(options, verify, getAccessToken, saveAccessToken) {
    ...
    const { corpId, corpSecret, agentId, callbackURL, scope, scopeSeparator, state, passReqToCallback } = options;
  ...
  async authenticate(req, options = {}) {
    ...
    if (req.query && req.query.code) {
      ...
      const location = isWorkWechatBrowser ? this._oauth.getAuthorizeUrl(params) : this._oauth.getQRAuthorizeUrl(params);
